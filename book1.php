        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center">
          ...
          <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
          	<form action="#" class="request-form ftco-animate">
	    	    ...
	    	    <h2>Add Details of Passenger</h2>			
             
              <div class="form-group">
                <label class="label">Please Select Your Title</label>
			 ...
			 <div class="form-group">
                ...
                <input type="text" class="form-control" name="fulname" placeholder="Please Enter Your Full Name . . .  ">
              </div>
			 
              <div class="form-group">
                <label for="" class="label">Phone No.</label>
                <input type="phone" class="form-control" name="phone" placeholder="Please Enter Your Phone No. .">
              </div>
			      <div class="form-group">
                ...
                <input type="Email" class="form-control" name="email" placeholder="Please Enter Your Email">
			      ...
			      <div class="form-group">
	              <button type="submit" name="search" class="btn btn-primary py-3 px-4">Save Details</button>
	            </div>
