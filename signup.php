	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="book.html" class="nav-link">My Bookings</a></li>
			  ...
			  <li class="nav-item active"><a href="log.html" class="nav-link">Login/Sign Up</a></li> 
	        </ul>
	      </div>
	    </div>
	  </nav>
          ...
          <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
          	<form method="Post" class="request-form ftco-animate">
          		<h2>Make your trip</h2>
						...
						<div class="form-group">
	    					<label for="" class="label">Membership ID</label>
	    					<input type="text" name="mem" class="form-control" placeholder="Membership no . . ">
	    				</div>
						<div class="form-group">
						...
						<div class="form-group ml-2">
	    					...
	    					<input type="text" name="phassword" class="form-control" placeholder="Re-Enter Password . . ">
                          </div>
	    				</div>
	    				<div class="d-flex">
	    					<div class="form-group mr-2">
	                <button type="submit" name="log" class="btn btn-primary py-3 px-4">Login</button>
	              </div>
				  
	              <div class="form-group ml-2">
	                  <button type="submit" name="register" class="btn btn-primary py-3 px-4">SignUp</button>
	              </div>
              </div>
					  ...
					  if(isset($_POST['register']))
		               {
		                     ...
		                     // get values form input text and number
		                      ...
		                      $con=mysqli_connect($host,$user,$pass,$db);
                               ...
                               $query1 = "INSERT INTO `user_info`(`Name`, `Email`, `Member_id`, `Phone` , `Password`) VALUES ('$name','$email','$mem','$phone','$phass')";
                               $query2 = "INSERT INTO `login`(`Member_id`, `Password`, `Stat`) VALUES ('$mem','$phass','$stat')";
	           ...
	           <!-- <div class="form-group">
	              <input type="submit" value="Search Flights" class="btn btn-primary py-3 px-4">
	            </div> -->
	    			</form>
          </div>
        </div>
