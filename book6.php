...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Air<span>creikey</span></a>
        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center">
          ...
          <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
          	<form action="#" method="Post" class="request-form ftco-animate">
	    	    ...
	    	    <h2>Add Details of 6 Passenger</h2>			
                 <div class="d-flex">             
              <div class="form-group">
                <label class="label">Title</label>
              <select name="pass1title"  class="form-control">
			 ...
			 <div class="form-group">
                <label for="" class="label">Name Passenger </label>
                <input type="text" class="form-control" name="pass1name" placeholder="Passenger 1">
              </div>
			  </div>
			   <div class="d-flex">
               <div class="form-group">
                <label class="label">Title</label>
              <select name="pass2title"  class="form-control">
		                      	<option value="Mr.">Mr.</option>
		                        <option value="Mrs.">Mrs.</option>
		                        <option value="Miss.">Miss.</option>
								</select>
			 ...
			 <div class="form-group">
                <label for="" class="label">Name Passenger </label>
                <input type="text" class="form-control" name="pass2name" placeholder="Passenger 2  ">
              </div>
			  </div>
			  <div class="d-flex">
			   <div class="form-group mr-2">
			   <label class="label">Title </label>
              <select name="pass3title"  class="form-control">
		                      	<option value="Mr.">Mr.</option>
		                        <option value="Mrs.">Mrs.</option>
		                        <option value="Miss.">Miss.</option>
								</select>
				...
				<label for="" class="label">Name Passenger</label>
                <input type="text" class="form-control" name="pass3name" placeholder="Passenger 3  ">
                 </div>
               </div>
               <div class="d-flex">
			   <div class="form-group mr-2">
			   <label class="label">Title </label>
              <select name="pass4title"  class="form-control">
		                      	<option value="Mr.">Mr.</option>
		                        <option value="Mrs.">Mrs.</option>
		                        <option value="Miss.">Miss.</option>
								</select>
			  	 ...
			  	 <div class="form-group ml-2">
				<label for="" class="label">Name Passenger</label>
                <input type="text" class="form-control" name="pass4name" placeholder="Passenger 4  ">
                 </div>
               </div>			   
			   ...
			   <div class="form-group mr-2">
			   <label class="label">Title </label>
              <select name="pass5title"  class="form-control">
		                      	<option value="Mr.">Mr.</option>
		                        <option value="Mrs.">Mrs.</option>
		                        <option value="Miss.">Miss.</option>
								</select>
			  	 ...
			  	 <div class="form-group ml-2">
				<label  class="label">Name of   Passenger</label>
                <input type="text" class="form-control" name="pass5name" placeholder="Passenger 5  ">
                 </div>
               </div>
			   	  <div class="d-flex">
			   <div class="form-group mr-2">
			   <label class="label">Title </label>
              <select name="pass6title"  class="form-control">
		                      	<option value="Mr.">Mr.</option>
		                        <option value="Mrs.">Mrs.</option>
		                        <option value="Miss.">Miss.</option>
								</select>
			  	 ...
			  	 <div class="form-group ml-2">
				<label  class="label">Name of   Passenger</label>
                <input type="text" class="form-control" name="pass6name" placeholder="Passenger 6  ">
                 </div>
               </div>
			   <div class="form-group ml-2">
                    <button type="submit" name="save" class="btn btn-primary py-3 px-4">Save Details</button>
	            </div>
					  ...
					  if(isset($_POST['save']))
		               {
		                ...
		                $con=mysqli_connect($host,$user,$pass,$db);
		                     // get values form input text and number
                               ...
                               $title1 = $_POST['pass1title'];
							   $name1 = $_POST['pass1name'];                               
                               $title2 = $_POST['pass2title'];
                               $name2 = $_POST['pass2name'];
							   $title3 = $_POST['pass3title'];
                               $name3 = $_POST['pass3name'];
                               $title4 = $_POST['pass4title'];
                               $name4 = $_POST['pass4name'];
                               $title5 = $_POST['pass5title'];
                               $name5 = $_POST['pass5name'];
							   $title6 = $_POST['pass6title'];
                               $name6 = $_POST['pass6name'];
							   ...
							   $memid=$row['Member_id'];
							   $no=1;
							   $sql1 = "INSERT INTO `passengers`(`Member_id`, `passangerNo`, `title`, `name`) VALUES ('$memid','$no','$title1','$name1')";
							   mysqli_query($con,$sql1);
							   
							   $no=2;
							   $sql2 = "INSERT INTO `passengers`(`Member_id`, `passangerNo`, `title`, `name`) VALUES ('$memid','$no','$title2','$name2')";
							   mysqli_query($con,$sql2);

                               $no=3;
							   $sql3 = "INSERT INTO `passengers`(`Member_id`, `passangerNo`, `title`, `name`) VALUES ('$memid','$no','$title3','$name3')";
							   mysqli_query($con,$sql3);

                               $no=4;
							   $sql4 = "INSERT INTO `passengers`(`Member_id`, `passangerNo`, `title`, `name`) VALUES ('$memid','$no','$title4','$name4')";
							   mysqli_query($con,$sql4);
							   
							   $no=5;
							   $sql5 = "INSERT INTO `passengers`(`Member_id`, `passangerNo`, `title`, `name`) VALUES ('$memid','$no','$title5','$name5')";
							   mysqli_query($con,$sql5);
							    
							   $no=6;
							   $sql6 = "INSERT INTO `passengers`(`Member_id`, `passangerNo`, `title`, `name`) VALUES ('$memid','$no','$title6','$name6')";
							   mysqli_query($con,$sql6);	
    
                                if($sql6)
                                {
                                     header('location:book.php');                                
								//   echo 'Data Inserted into info';
                                }
