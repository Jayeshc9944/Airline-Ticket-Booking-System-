        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center">
          ...
          <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
          	<form action="#" method="Post" class="request-form ftco-animate">
	    	    ...
	    	    <h2>Add Details of 2 Passenger</h2>			
             
              <div class="form-group">
                <label class="label">Title For Passenger 1</label>
			 ...
			 <div class="form-group">
                <label for="" class="label">Name Passenger 1</label>
                <input type="text" class="form-control" name="pass1name" placeholder="Name  ">
              </div>
               <div class="form-group">
                <label class="label">Title For Passenger 2</label>
			 ...
			 <div class="form-group">
                <label for="" class="label">Name Passenger 2</label>
                <input type="text" class="form-control" name="pass2name" placeholder="Name  ">
              </div>
