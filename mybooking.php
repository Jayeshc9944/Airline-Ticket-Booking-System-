	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="mybooking.php" class="nav-link">My Bookings</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text justify-content-start align-items-center">
         <<div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
          <div class="text">
	         <!--   <h1 class="mb-4">Now <span>It's easy for you</span> <span>Book A Ticket</span></h1>
		...
		$con=mysqli_connect($host,$user,$pass,$db); 
		    ...
		    $memid=$row['Member_id'];	
             ...
             $sql1= "select * from user_flight_info where Member_id='$memid'";
             $data1=mysqli_query($con,$sql1);
			 $rowcount1=mysqli_fetch_array($data1);
			 $ser=$rowcount1['ser_id'];
			 $tpas=$rowcount1['tot_pass'];
			 $bstat=$rowcount1['booking_stat'];
			 $pstat=$rowcount1['payment_stat'];
			 $txid=$rowcount1['txn_id'];
			
             $sql2= "select * from master where ser_id='$ser'";
			 $data2=mysqli_query($con,$sql2);
			 $rowcount2=mysqli_fetch_array($data2);
			 $tocid=$rowcount2['depart_city_id'];
			 $fcid=$rowcount2['desti_city_id'];
			 $dedid=$rowcount2['depart_date_id'];
			 $detid=$rowcount2['depart_time_id'];
			 $pid=$rowcount2['air_plane_id'];
			 
			 
			 //form
             $sql3= "select * from cities where ct_id='$tocid'";
			 $data3=mysqli_query($con,$sql3);
			 $rowcount3=mysqli_fetch_array($data3);
			 $tocname=$rowcount3['city_name'];


             //to
			 $sql4= "select * from cities where ct_id='$fcid'";
			 $data4=mysqli_query($con,$sql4);
			 $rowcount4=mysqli_fetch_array($data4);
			 $fcname=$rowcount4['city_name'];
			 
			 //date
			 $sql5= "select * from  dates where date_id='$dedid'";
			 $data5=mysqli_query($con,$sql5);
			 $rowcount5=mysqli_fetch_array($data5);
			 $toda=$rowcount5['date'];

            //time
			 $sql6= "select * from  time where time_id='$detid'";
			 $data6=mysqli_query($con,$sql6);
			 $rowcount6=mysqli_fetch_array($data6);
			 $totim=$rowcount6['time'];

			 
?>

          <div class="col-lg-2 col"></div>
          <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex" align="center">
          	<form  method="Post" class="request-form ftco-animate">
          		<h2>Make your trippppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp</h2>
				<div class="d-flex"> 
                   <div class="form-group mr-2">
	    				<div class="form-group">
	    					<label for="" class="label">Your location</label>
	    					<input type="text" class="form-control" value="<?php echo "$tocname"; ?>">
	    				</div>
						</div>
                      <div class="form-group ml-2">
	    				<div class="form-group">
	    					<label for="" class="label">Destination location</label>
	    					<input type="text" class="form-control"  value="<?php echo "$fcname"; ?>">
	    				</div>
						</div>
						</div>
	    				<div class="d-flex">
	                ...
	                <input type="text" class="form-control"  value="<?php echo "$toda"; ?>">
	              </div>
	              <div class="form-group ml-2">
	                <label for="" class="label">Flight Time</label>
	               <input type="text" class="form-control"  value="<?php echo "$totim"; ?>">
	              </div>
              </div>
			  <div class="d-flex">
              <div class="form-group">
                <label for="" class="label">Passengers</label>
                <input type="text" class="form-control"  value="<?php echo "$tpas"; ?>">
              </div>
			    <div class="form-group">
                <label for="" class="label">Booking Status</label>
                 <input type="text" class="form-control"  value="<?php echo "$bstat"; ?>">
              </div>
			  </div>
			   <div class="d-flex">
              <div class="form-group">
                <label for="" class="label">Payment Status</label>
                <input type="text" class="form-control"  value="<?php echo "$pstat"; ?>">
              </div>
			    <div class="form-group">
                <label for="" class="label">Transaction id</label>
                 <input type="text" class="form-control"  value="<?php echo "$txid"; ?>">
              </div>
			  </div>
			  <div class="d-flex">
			  <div class="form-group mr-2">
	            <div class="form-group">
				 <button type="submit" name="pdf" class="btn btn-primary py-3 px-4">Save Pdf</button>
	       	            </div>
				 </div>
				 <div class="form-group ml-2">
				  <div class="form-group">
				  <button type="submit" name="cancel" class="btn btn-primary py-3 px-4">Cancel Flight</button>
	            </div>
				 </div>
				 </div>
				 <?php
				  ...
				  if(isset($_POST["cancel"]))
					   {
						  ...
						  echo $memid;
						  echo $ser;
						  $del = "DELETE  FROM `user_flight_info` WHERE Member_id='$memid' && ser_id='$ser'";
