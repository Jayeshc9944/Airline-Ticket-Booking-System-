	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item active"><a href="log.php" class="nav-link">Login/Sign Up</a></li> 
	        </ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text justify-content-start align-items-center">
          <div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
		   ...
		   <?php
				          ...
				          if(isset($_POST["submit_lo"]))
		                  {
                                 ...
                                 $query= "select * from login where Member_id='$login_id' && Password='$pass_word'";
								 ...
								 { 
							         $se="none";    
									 $sql1 = "UPDATE `login` SET `Stat`=1 WHERE Member_id='$login_id'";
									 mysqli_query($con,$sql1);
									 $sql2 = "UPDATE `at_instance` SET `Member_id`='$login_id',`login_stat`=1,`booking_stat`=0,`seridd`='$se' WHERE id=15";
          ...
          <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
          	<form action="" class="request-form ftco-animate" method="Post">
          		<h2>Make your trip</h2>
	    				<div class="form-group">
	    					<label for="" class="label">Login id</label>
	    					<input type="text" name="login" class="form-control" placeholder="Membership no">
					 ...
					 <button type="submit" name="submit_lo" class="btn btn-primary py-3 px-4">Login</button>
					 
	              </div>
				  <div class="form-group ml-2">
					 <button type="submit" name="submit_su" class="btn btn-primary py-3 px-4">SignUp</button>
	              </div>
              </div>
