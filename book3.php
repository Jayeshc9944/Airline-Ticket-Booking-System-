         ...
         <<div class="col-lg-6 col-md-6 ftco-animate d-flex align-items-end">
          ...
          <div class="col-lg-4 col-md-6 mt-0 mt-md-5 d-flex">
          	<form action="#" method="Post" class="request-form ftco-animate">
	    	    ...
	    	    <h2>Add Details of 3 Passengerrrrrrrrrrrrrrrrrrrrrrrr</h2>			
                 <div class="d-flex">             
			 ...
			 <div class="form-group">
                ...
                <input type="text" class="form-control" name="pass1name" placeholder="Please Enter Name For Passenger 1">
              </div>
			  </div>
			   <div class="d-flex">
               <div class="form-group">
			 ...
			 <div class="form-group">
                <label for="" class="label">Name Passenger </label>
                <input type="text" class="form-control" name="pass2name" placeholder="Please Enter Name For Passenger 2  ">
              </div>
			  </div>
			  <div class="d-flex">
              ...
              <select name="pass3title"  class="form-control">
				...
				<label for="" class="label">Name Passenger</label>
                <input type="text" class="form-control" name="pass3name" placeholder="Please Enter Name For Passenger 3  ">
                 </div>
               </div>				 
                <div class="form-group ml-2">
